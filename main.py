...
if not check_auth():
    ...
    if st.session_state.ai_provider == "Gemini":
        ...
        st.session_state.target_model = st.sidebar.selectbox("Model", ["tencent/hy3-preview:free", "inclusionai/ling-2.6-1t:free", "minimax/minimax-m2.5:free", "openai/gpt-oss-120b:free"])
